...
namespace Player
{
    ...
    public class PlayerScriptableStats : ScriptableObject
    {
        ...
        [Header("COLLISION")]
        public bool EnableLedgeCorrection = true;
        public LayerMask CollisionMask = ~0;
        public LayerMask HazardMask = ~0;
        public LayerMask EnemyMask = ~0;
        public LayerMask TriggerCollisionMask = ~0;

        public LayerMask AttackTargetMask = ~0;
        public LayerMask AttackNonTargetMask = ~0;
        ...
        public float KnockBackAirDistance = 0.1f;
        ...
        public float KnockBackAirSpeed
        {
            get
            {
                return 2f * KnockBackAirDistance / KnockBackTime;
            }
        }
        ...
        public float KnockAirNoInputDeceleration
        {
            get
            {
                return KnockBackAirDistance / KnockAirNoInputDecelerationTime;
            }
        }
        ...
        public float KnockAirTurnAroundDeceleration
        {
            get
            {
                return KnockBackAirDistance / KnockAirTurnAroundTime;
            }
        }
